...
# Flag when the new attribute https_traffic_only_enabled is missing
title := "Storage Account should enforce HTTPS traffic only"
...
# Flag when the new attribute https_traffic_only_enabled is explicitly set to false
CxPolicy[result] {
    resource := input.document[i].resource.azurerm_storage_account[var0]
