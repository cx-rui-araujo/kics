...
CxPolicy[result] {
	...
	resource.fifo_throughput_scope == "MESSAGE_GROUP_ID"
	...
	result := {
		...
		"issueType": "IncorrectValue",
		"keyExpectedValue": "SNS FIFO Topic should set fifo_throughput_scope to TOPIC to prevent DoS",
		"keyActualValue": "SNS FIFO Topic uses per message group throughput scope",
	}
}