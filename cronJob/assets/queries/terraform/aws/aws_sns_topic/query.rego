...
CxPolicy[result] {
	...
	resource.fifo_throughput_scope == "perMessageGroupId"
	...
	result := {
		...
		"issueType": "IncorrectValue",
		"keyExpectedValue": "fifo_throughput_scope should not be set to perMessageGroupId",
		"keyActualValue": "fifo_throughput_scope is set to perMessageGroupId",
	}
}