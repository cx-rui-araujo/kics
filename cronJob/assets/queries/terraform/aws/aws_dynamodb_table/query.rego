...
# New check: Ensure point_in_time_recovery.recovery_period_in_days is at least 7 days
CxPolicy[result] {
    ...
    # Flag if recovery_period_in_days is set and less than 7
    ...
    result := {
        ...
        "remediation": json.marshal({
            "before": sprintf("%v", [recovery.recovery_period_in_days]),
            "after": "7"
        }),
