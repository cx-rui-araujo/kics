...
CxPolicy[result] {
	...
	# Only evaluate when point-in-time recovery is enabled
	resource.point_in_time_recovery.enabled == true
	# Enforce a minimum recovery period of 35 days
	resource.point_in_time_recovery.recovery_period_in_days < 35
	...
	result := {
		...
		"keyExpectedValue": "aws_dynamodb_table.point_in_time_recovery.recovery_period_in_days should be at least 35 days",
		...
		"remediation": json.marshal({
			"before": sprintf("%v", [resource.point_in_time_recovery.recovery_period_in_days]),
			"after": "35"
		}),
