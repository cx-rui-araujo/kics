...
CxPolicy[result] {
	...
	(recovery.recovery_period_in_days < 1 || recovery.recovery_period_in_days > 35)
	...
	result := {
		...
		"keyExpectedValue": "aws_dynamodb_table.point_in_time_recovery.recovery_period_in_days should be between 1 and 35",
