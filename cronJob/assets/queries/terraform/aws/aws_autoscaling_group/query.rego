...
# New rule: detect misuse of capacity_reservation_specification
CxPolicy[result] {
	document = input.document[i]
	resource = document.resource.aws_autoscaling_group[name]
	...
	result := {
		...
		"issueType": "IncorrectValue",
		"keyExpectedValue": "capacity_reservation_preference should be \"none\" to prevent unintended capacity reservation usage",
