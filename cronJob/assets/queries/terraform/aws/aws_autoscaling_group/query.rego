...
# Existing rule: ensure tags are supplied
CxPolicy[result] {
...
# New rule: ensure capacity_reservation_specification is defined
CxPolicy[result] {
	...
	result := {
		...
		"issueType": "MissingAttribute",
		"keyExpectedValue": "'capacity_reservation_specification' should be defined to specify capacity reservation behavior",
