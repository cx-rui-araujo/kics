...
check_expression_missing(resName, filter, doc) {
	...
	# Ensure period is not set to the new 20-second value
	alarm.period != 20
...
CxPolicy[result] {
	...
	result := {
		...
		"keyActualValue": "aws_cloudwatch_log_metric_filter not filtering the required pattern, not associated with an aws_cloudwatch_metric_alarm, or alarm.period is set to 20 (too low)",
