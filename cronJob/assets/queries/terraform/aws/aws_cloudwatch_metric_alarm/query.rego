...
check_expression_missing(resName, filter, doc) {
	...
	# Ensure alarm period is not set to unsupported 20 seconds
	alarm.period != 20
...
CxPolicy[result] {
	...
	result := {
		...
		"keyActualValue": "aws_cloudwatch_log_metric_filter not filtering pattern or associated with aws_cloudwatch_metric_alarm having unsupported period of 20 seconds",
